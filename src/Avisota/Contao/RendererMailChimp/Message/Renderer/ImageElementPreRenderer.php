 ...
 * @package    avisota/contao-renderer-mailchimp
 */
class ImageElementPreRenderer implements Renderer\MessageContentPreRendererInterface
{
	/**
	 * @var string
	 */
	const TEMPLATE = 'avisota/message/renderer/mailchimp/mce_image';
